...
(function($) {
	...
	var data_set = {
		labels: ['Ecosystem', 'Team & Advisors', 'Holding', 'Treasury', 'Private sale', 'Public Round', 'Play To Earn'],
		titles: '',
		datasets: [{
			label: "949",
			lineTension: 0,
			backgroundColor: ['#15B439', pie_color, pie_color, pie_color, pie_color, pie_color, pie_color],
